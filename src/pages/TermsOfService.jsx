...
function TermsOfService() {
    return (
        <Container className="mt-5 mb-5">
            ...
            <p>By accessing this Website, accessible from the <Link to="/" className='text-white text-decoration-none'>coinzbot website</Link>, you
            ...
            <p>Please read our <Link to="/privacy" className='text-white text-decoration-none'>Privacy Policy</Link>.</p>
